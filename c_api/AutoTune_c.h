...
FAISS_C_API int faiss_ParameterSpace_set_index_parameters_binary(
        const FaissParameterSpace*,
        FaissIndexBinary*,
        const char*);

/// set a combination of parameters on a binary index
FAISS_C_API int faiss_ParameterSpace_set_index_parameters_cno_binary(
        const FaissParameterSpace*,
        FaissIndexBinary*,
        size_t);
...
FAISS_C_API int faiss_ParameterSpace_set_index_parameter_binary(
        const FaissParameterSpace*,
        FaissIndexBinary*,
        const char*,
        double);
